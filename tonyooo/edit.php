...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE users_tb SET firstname='$firstname', middlename='$middlename', lastname='$lastname', province='$province', municipality='$municipality', barangay='$barangay' WHERE id='$id'";
