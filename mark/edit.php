...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE users2_tb SET firstname='$firstname', middlename='$middlename', lastname='$lastname', province='$province', municipality='$municipality', barangay='$barangay' WHERE id='$id'";
...
$result = mysqli_query($conn, "SELECT * FROM users_tb WHERE id='$id'");
